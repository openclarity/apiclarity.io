...
const HeaderSection = () => {
	return (
		<div className={styles.HeaderSection}>
			...
			<h2>Learn more about <br />APIClarity</h2>
			<p className={styles.HeaderSectionShortText}>Check out the latest blog articles, podcasts, videos, and more from the APIClarity community.</p>
		</div>
	)
}
